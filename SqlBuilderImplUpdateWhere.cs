...
namespace Obj2Sql {    
    public class SqlBuilderImplUpdateWhere<T>: 
        SqlBuilderImplUpdateFields<SqlBuilderImplUpdateWhere<T>> where T: 
        SqlBuilderImplUpdateWhere<T> {

        public T Where(string campo) {

            this.sql.SqlString = "where(string)";
